      ...
      >
        ...
        <div className="mt-6 space-y-3">
          <button
            ...
            className="w-full rounded-full bg-gradient-to-r from-red-600 to-red-800 py-3.5 text-sm font-bold text-white shadow-lg shadow-red-600/25 transition-transform hover:scale-[1.03]"
          >
            Основная ссылка
          </button>
          <button
